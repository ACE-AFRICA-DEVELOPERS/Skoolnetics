...
const promotedClass = selector("#promotedClass")
...
submit.addEventListener("click", event => {
    ...
    if(promotedClass.value != ''){
        ...
        if (targetStudents.length > 0){
            ...
            sendData(`/school/students/promote/${spanClass.textContent}` , {target: targetStudents, classID: promotedClass.value})
            .then(res => {
        ...
        displayMsg.textContent = "You need to select a class first."
    }
})
